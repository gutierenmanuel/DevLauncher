...
echo -e "    Abre el lanzador interactivo de scripts"
echo ""
echo -e "  ${GREEN}devscript <nombre>${NC}"
echo -e "    Ejecuta un script por nombre directamente"
echo -e "    Ejemplo: ${CYAN}devscript dev.sh${NC}"
echo -e "              ${CYAN}devscript init_frontend_project.sh${NC}"
echo ""

...
5. Sincronizar y registrar cambios de la tarea: ejecutar `git pull`, crear uno o varios commits según bloques de cambio, y ejecutar `git push`.
6. Si hay cambios de distinta naturaleza, separarlos en commits diferentes.
7. Cada commit debe incluir descripción larga en español explicando qué cambia y por qué.
8. Reportar qué se cambió y qué rule del índice se usó.

## Comandos de soporte en `.github/commands`

- `git push` → ver `commands/git/push.md`.
